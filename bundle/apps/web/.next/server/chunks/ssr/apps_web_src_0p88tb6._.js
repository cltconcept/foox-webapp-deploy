module.exports=[20614,a=>{"use strict";a.s(["Explainer",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call Explainer() from the server but Explainer is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/ligues/explainer.tsx","Explainer")},5692,a=>{"use strict";var b=a.i(20614);a.n(b)},14205,a=>{"use strict";a.s(["LeagueForms",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call LeagueForms() from the server but LeagueForms is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/ligues/league-forms.tsx","LeagueForms")},75357,a=>{"use strict";var b=a.i(14205);a.n(b)},55792,a=>{"use strict";a.s(["Segments",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call Segments() from the server but Segments is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/ligues/segments.tsx","Segments")},91023,a=>{"use strict";var b=a.i(55792);a.n(b)},22453,a=>{"use strict";a.s(["ShareLeague",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call ShareLeague() from the server but ShareLeague is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/ligues/share-league.tsx","ShareLeague")},61848,a=>{"use strict";var b=a.i(22453);a.n(b)},18326,a=>{"use strict";a.s(["SheetPlus",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call SheetPlus() from the server but SheetPlus is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/ligues/sheet.tsx","SheetPlus")},2886,a=>{"use strict";var b=a.i(18326);a.n(b)},97878,a=>a.a(async(b,c)=>{try{var d=a.i(59597),e=a.i(56963);a.i(43668);var f=a.i(88156),g=a.i(18145),h=a.i(90157),i=a.i(87217),j=a.i(5692),k=a.i(75357),l=a.i(91023),m=a.i(61848),n=a.i(2886),o=b([g,h,i]);[g,h,i]=o.then?(await o)():o;let s=["🥇","🥈","🥉"];function p({l:a,moi:b}){return(0,d.jsxs)("div",{className:`flex items-center gap-3 px-3.5 py-2.5 ${a.userId===b?"bg-renard/8":""}`,children:[(0,d.jsx)("span",{className:"w-7 text-center shrink-0",children:a.rank<=3?(0,d.jsx)("span",{className:"text-lg",children:s[a.rank-1]}):(0,d.jsx)("span",{className:"font-mono text-sourdine-2 text-sm",children:a.rank})}),(0,d.jsxs)("span",{className:"flex-1 text-sm text-encre truncate",children:[a.name,a.userId===b?(0,d.jsx)("span",{className:"text-renard text-xs",children:" · toi"}):null]}),void 0!==a.pending&&a.pending>0?(0,d.jsxs)("span",{className:"text-[11px] font-mono text-renard shrink-0",children:["+",a.pending," en jeu"]}):null,void 0!==a.settled?(0,d.jsxs)("span",{className:"text-[10px] text-sourdine-2 shrink-0",children:[a.settled,"/",a.totalPicks]}):null,(0,d.jsxs)("span",{className:"font-mono font-black text-encre text-sm shrink-0",children:[a.points," pts"]})]})}function q({lignes:a,moi:b}){if(0===a.length)return(0,d.jsx)("p",{className:"px-4 py-3 text-sm text-sourdine-2",children:"Aucun pronostic jugé pour l'instant."});let c=a.slice(0,3),e=a.find(a=>a.userId===b&&a.rank>3),f=a.slice(3).filter(a=>a.userId!==b);return(0,d.jsxs)("div",{className:"divide-y divide-ligne",children:[c.map(a=>(0,d.jsx)(p,{l:a,moi:b},a.userId)),e?(0,d.jsxs)(d.Fragment,{children:[e.rank>4?(0,d.jsx)("p",{className:"px-3.5 py-0.5 text-center text-[10px] text-sourdine-2",children:"⋯"}):null,(0,d.jsx)(p,{l:e,moi:b})]}):null,f.length>0?(0,d.jsxs)("details",{children:[(0,d.jsxs)("summary",{className:"px-3.5 py-2 text-center text-[11px] text-renard font-bold cursor-pointer list-none",children:["voir les ",f.length," autres ▾"]}),(0,d.jsx)("div",{className:"divide-y divide-ligne border-t border-ligne",children:f.map(a=>(0,d.jsx)(p,{l:a,moi:b},a.userId))})]}):null]})}async function r(){let a=await g.auth.api.getSession({headers:await (0,e.headers)()});a||(0,f.redirect)("/login");let b=a.user.id,[c,o,p,r]=await Promise.all([(0,h.myLeagues)(b),(0,h.standings)(),(0,h.myPickHistory)(b),(0,i.weeklyRace)()]),s=p.filter(a=>a.settled),t=s.reduce((a,b)=>a+(b.points??0),0),u=p.length>0,v=(0,d.jsxs)("div",{className:"rounded-2xl bg-surface border-2 border-renard/40 overflow-hidden",children:[(0,d.jsxs)("div",{className:"px-4 py-3 border-b border-ligne",children:[(0,d.jsx)("p",{className:"text-encre font-semibold",children:"🏁 La course de la semaine"}),(0,d.jsx)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:"Tout le monde repart à zéro lundi. « En jeu » = les points de tes pronos pas encore joués."})]}),0===r.length?(0,d.jsx)("p",{className:"px-4 py-3 text-sm text-sourdine-2",children:"Personne dans la course — un prono cette semaine suffit pour entrer."}):(0,d.jsx)(q,{lignes:r,moi:b})]}),w=(0,d.jsxs)("div",{className:"space-y-3",children:[(0,d.jsxs)("div",{className:"rounded-2xl bg-surface border border-ligne p-4 flex items-baseline justify-between",children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("p",{className:"text-[10px] uppercase tracking-wider text-sourdine-2",children:"ta saison"}),(0,d.jsxs)("p",{className:"text-encre text-2xl font-black font-mono",children:[t," pts"]})]}),(0,d.jsxs)("p",{className:"text-xs text-sourdine-2 text-right",children:[s.filter(a=>a.won).length," réussi",s.filter(a=>a.won).length>1?"s":""," sur ",s.length," jugé",s.length>1?"s":"",(0,d.jsx)("br",{}),p.length-s.length," en attente"]})]}),(0,d.jsxs)("div",{className:"rounded-2xl bg-surface border border-ligne overflow-hidden",children:[(0,d.jsxs)("div",{className:"px-4 py-3 border-b border-ligne",children:[(0,d.jsx)("p",{className:"text-encre font-semibold",children:"🌍 Classement général"}),(0,d.jsx)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:"Tous les joueurs de Foox, depuis le début de la saison."})]}),(0,d.jsx)(q,{lignes:o,moi:b})]}),p.length>0?(0,d.jsxs)("details",{className:"rounded-2xl bg-surface border border-ligne overflow-hidden",children:[(0,d.jsxs)("summary",{className:"px-4 py-3 text-sm text-encre font-semibold cursor-pointer list-none flex items-center justify-between",children:["Mes pronostics",(0,d.jsxs)("span",{className:"text-[11px] text-renard font-bold",children:[p.length," ▾"]})]}),(0,d.jsx)("div",{className:"border-t border-ligne overflow-x-auto",children:(0,d.jsx)("table",{className:"w-full text-sm min-w-[480px]",children:(0,d.jsx)("tbody",{children:p.map(a=>(0,d.jsxs)("tr",{className:"border-b border-ligne last:border-b-0",children:[(0,d.jsxs)("td",{className:"px-4 py-2 text-sourdine",children:[(0,d.jsx)("span",{className:"text-encre",children:a.home})," — ",a.away,(0,d.jsxs)("span",{className:"block text-[10px] text-sourdine-2",children:[new Date(a.kickoffUtc).toLocaleDateString("fr-BE",{timeZone:"UTC"}),a.score?` \xb7 ${a.score}`:""]})]}),(0,d.jsx)("td",{className:"px-3 py-2 text-xs text-sourdine",children:"home"===a.outcome?"domicile":"draw"===a.outcome?"nul":"extérieur"}),(0,d.jsx)("td",{className:"px-4 py-2 text-right font-mono",children:a.settled?a.won?(0,d.jsxs)("span",{className:"text-vert font-bold",children:["+",a.points," pts"]}):(0,d.jsx)("span",{className:"text-rouge",children:"0 pt"}):(0,d.jsxs)("span",{className:"text-sourdine-2",children:["+",a.potential," pts ?"]})})]},a.matchId))})})})]}):null]}),x=(0,d.jsxs)("div",{className:"space-y-3",children:[(0,d.jsx)("p",{className:"text-[11px] text-sourdine-2",children:"Un classement rien qu'entre amis, sur toute la saison. Le bouton « Inviter » envoie le lien qui fait tout."}),c.map(a=>(0,d.jsxs)("div",{className:"rounded-2xl bg-surface border border-ligne overflow-hidden",children:[(0,d.jsxs)("div",{className:"px-4 py-3 border-b border-ligne flex items-center justify-between gap-3",children:[(0,d.jsxs)("div",{className:"min-w-0",children:[(0,d.jsx)("p",{className:"text-encre font-semibold truncate",children:a.name}),(0,d.jsxs)("p",{className:"text-xs text-sourdine-2",children:["code ",a.code]})]}),(0,d.jsx)(m.ShareLeague,{name:a.name,code:a.code})]}),(0,d.jsx)(q,{lignes:a.standings,moi:b})]},a.id)),(0,d.jsx)(n.SheetPlus,{children:(0,d.jsx)(k.LeagueForms,{})})]});return(0,d.jsxs)("div",{className:"max-w-md mx-auto space-y-5",children:[(0,d.jsxs)("div",{className:"flex items-start justify-between gap-3",children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("h1",{className:"text-encre text-xl font-bold",children:"Ligues"}),(0,d.jsx)("p",{className:"text-sm text-sourdine mt-0.5",children:"Défie tes amis, grimpe les classements. Gratuit, sans mise — la gloire seule."})]}),u?(0,d.jsx)(j.Explainer,{initialOuvert:!1}):null]}),u?null:(0,d.jsx)(j.Explainer,{initialOuvert:!0}),(0,d.jsx)(l.Segments,{semaine:v,saison:w,ligues:x})]})}a.s(["default",0,r,"dynamic",0,"force-dynamic"]),c()}catch(a){c(a)}},!1),64733,function(a){a.n(a.i(97878))},90157,a=>a.a(async(b,c)=>{try{var d=a.i(66680),e=a.i(62332),f=a.i(21592),g=a.i(31415),h=a.i(49232),i=b([g]);function j(a){return Math.round(100*(1-a))}async function k(a){let b=await g.db.select({matchId:h.schema.picks.matchId,outcome:h.schema.picks.outcome,pAtPick:h.schema.picks.pAtPick}).from(h.schema.picks).where((0,e.eq)(h.schema.picks.userId,a));return new Map(b.map(a=>[a.matchId,{outcome:a.outcome,pAtPick:a.pAtPick}]))}async function l(a){return(await g.db.execute(f.sql`
