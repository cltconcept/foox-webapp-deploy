module.exports=[91723,a=>a.a(async(b,c)=>{try{var d=a.i(59597),e=a.i(56963),f=a.i(38045);a.i(43668);var g=a.i(88156),h=a.i(18145),i=a.i(90157),j=a.i(87217),k=a.i(93221),l=a.i(71512),m=a.i(4689),n=a.i(54608),o=b([h,i,j,k,l,m]);async function p(){let a=await h.auth.api.getSession({headers:await (0,e.headers)()});a||(0,g.redirect)("/login");let b=a.user.id,[c,o,p,q,r,s]=await Promise.all([(0,l.upcomingFixtures)(),(0,i.myPicks)(b),(0,k.progression)(b),(0,i.standings)(),(0,i.myPickHistory)(b,40),(0,j.weeklyRace)()]),t=s.find(a=>a.userId===b),u=Date.now(),v=c.map(m.toFixture).filter(a=>new Date(a.kickoffUtc).getTime()>u),w=v.filter(a=>!o.has(a.matchId)).length,x=a.user.name.split(" ")[0]??a.user.name,y=q.find(a=>a.userId===b),z=r.filter(a=>!a.settled),A=z.reduce((a,b)=>a+b.potential,0),B=r.filter(a=>a.settled).slice(0,3),C=v[0]??null,D=p.level.next,E=D?(p.xp-p.level.minXp)/(D.minXp-p.level.minXp):1;return(0,d.jsxs)("div",{className:"max-w-md mx-auto space-y-6 pt-1",children:[(0,d.jsxs)("section",{className:"flex items-end gap-3 anim-rise",children:[(0,d.jsx)("img",{src:w>0?"/assets/mascotte/analyse.webp":"/assets/mascotte/clin_doeil.webp",alt:"La mascotte Foox",className:"w-20 shrink-0"}),(0,d.jsxs)("div",{className:"flex-1 rounded-2xl rounded-bl-sm bg-surface border border-ligne px-4 py-3",children:[(0,d.jsx)("p",{className:"text-sm text-encre font-semibold leading-snug",children:w>0?`${x}, ${w} match${w>1?"s":""} attend${w>1?"ent":""} ton prono !`:`Tout est pronostiqu\xe9, ${x}.`}),C?(0,d.jsxs)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:["prochain coup d'envoi ",function(a){let b=Math.round((a.getTime()-Date.now())/36e5);if(b<1)return"imminent";if(b<24)return`dans ${b} h`;let c=Math.round(b/24);return`dans ${c} jour${c>1?"s":""}`}(new Date(C.kickoffUtc))," :"," ",C.home," — ",C.away]}):null]})]}),(0,d.jsx)(f.default,{href:"/pronos",className:"btn-p text-center text-base py-4 anim-rise anim-rise-1",children:w>0?`Faire mes pronos (${w})`:"Revoir mes pronos"}),(0,d.jsxs)(f.default,{href:"/ligues",className:"block rounded-2xl border-2 border-renard/40 bg-renard/8 p-3.5 anim-rise anim-rise-2",children:[(0,d.jsxs)("div",{className:"flex items-center justify-between",children:[(0,d.jsx)("p",{className:"text-[10px] uppercase tracking-wider text-renard font-black",children:"🏁 course de la semaine"}),(0,d.jsx)("p",{className:"text-[10px] text-sourdine-2",children:"se termine dimanche soir"})]}),(0,d.jsxs)("div",{className:"flex items-baseline justify-between mt-1",children:[(0,d.jsx)("p",{className:"text-encre font-black text-lg",children:t?`${t.rank}ᵉ \xb7 ${t.points} pts`:"pas encore dans la course"}),t&&t.pending>0?(0,d.jsxs)("p",{className:"text-renard font-mono font-bold text-sm",children:["+",t.pending," en jeu"]}):null]}),s[0]&&s[0].userId!==b?(0,d.jsxs)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:["en tête : ",s[0].name," (",s[0].points," pts)"]}):t?(0,d.jsx)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:"tu mènes la course 👑"}):(0,d.jsx)("p",{className:"text-[11px] text-sourdine-2 mt-0.5",children:"un prono cette semaine suffit pour entrer"})]}),(0,d.jsx)("section",{className:"anim-rise anim-rise-3",children:(0,d.jsxs)(n.CarrouselGlisse,{peek:!0,children:[(0,d.jsxs)(f.default,{href:"/ligues",className:"carte-mini",children:[(0,d.jsx)("p",{className:"carte-mini-label",children:"saison"}),(0,d.jsx)("p",{className:"carte-mini-chiffre",children:p.points}),(0,d.jsxs)("div",{className:"mt-auto text-[10px] text-sourdine-2 leading-snug",children:[(0,d.jsx)("p",{className:"truncate",children:y?`${y.rank}ᵉ au g\xe9n\xe9ral`:"classement à venir"}),z.length>0?(0,d.jsxs)("p",{className:"truncate",children:[(0,d.jsxs)("span",{className:"text-renard font-mono font-bold",children:["+",A]})," en attente"]}):null]})]}),(0,d.jsxs)(f.default,{href:"/vestiaire",className:"carte-mini",children:[(0,d.jsxs)("p",{className:"carte-mini-label",children:["niveau ",p.level.name]}),(0,d.jsxs)("p",{className:"carte-mini-chiffre",children:["⚡ ",p.xp]}),(0,d.jsxs)("div",{className:"mt-auto",children:[(0,d.jsx)("div",{className:"h-1.5 rounded-full bg-surface-2 overflow-hidden",children:(0,d.jsx)("span",{className:"block h-full bg-renard rounded-full bar-anime",style:{width:`${Math.min(100,Math.round(100*E))}%`}})}),(0,d.jsx)("p",{className:"text-[10px] text-sourdine-2 mt-1.5 truncate",children:D?`${D.name} \xe0 ${D.minXp} XP`:"niveau max"})]})]}),(0,d.jsxs)("div",{className:"carte-mini",children:[(0,d.jsx)("p",{className:"carte-mini-label",children:"défis de la semaine"}),(0,d.jsxs)("p",{className:"carte-mini-chiffre",children:[p.weekChallenges.filter(a=>a.done).length,(0,d.jsxs)("span",{className:"text-sourdine-2",children:["/",p.weekChallenges.length]})]}),(0,d.jsx)("div",{className:"mt-auto space-y-1.5",children:p.weekChallenges.map(a=>(0,d.jsx)("div",{title:`${a.label} \xb7 ${a.current}/${a.target} \xb7 +${a.xp} XP`,className:"h-1.5 rounded-full bg-surface-2 overflow-hidden",children:(0,d.jsx)("span",{className:`block h-full rounded-full bar-anime ${a.done?"bg-vert":"bg-renard"}`,style:{width:`${Math.min(100,a.current/a.target*100)}%`}})},a.id))})]}),B.length>0?(0,d.jsxs)(f.default,{href:"/ligues",className:"carte-mini",children:[(0,d.jsx)("p",{className:"carte-mini-label",children:"derniers verdicts"}),(0,d.jsx)("div",{className:"flex items-center gap-1.5 mt-1.5",children:B.map(a=>(0,d.jsx)("span",{className:`w-7 h-7 rounded-full text-xs font-black flex items-center justify-center ${a.won?"bg-vert/15 text-vert":"bg-rouge/15 text-rouge"}`,children:a.won?"✓":"✗"},a.matchId))}),(0,d.jsxs)("p",{className:"mt-auto text-[10px] text-sourdine-2 truncate",children:[(0,d.jsxs)("span",{className:"text-vert font-mono font-bold",children:["+",B.reduce((a,b)=>a+(b.won?b.points??0:0),0)," pts"]})," ","sur les ",B.length," derniers"]})]}):null,(0,d.jsxs)(f.default,{href:"/analyses",className:"carte-mini border-jaune/40",children:[(0,d.jsx)("span",{className:"self-start rounded-full bg-jaune/15 border border-jaune/50 text-jaune text-[10px] font-black uppercase tracking-wider px-2 py-0.5",children:"Pro"}),(0,d.jsx)("p",{className:"text-sm text-encre font-semibold leading-snug mt-2",children:"Les analyses complètes"}),(0,d.jsx)("p",{className:"mt-auto text-[10px] text-sourdine-2 truncate",children:"probabilités, forme, météo →"})]})]})})]})}[h,i,j,k,l,m]=o.then?(await o)():o,a.s(["default",0,p,"dynamic",0,"force-dynamic"]),c()}catch(a){c(a)}},!1),21518,function(a){a.n(a.i(91723))},22105,a=>{"use strict";a.s(["CarrouselGlisse",()=>b]);let b=(0,a.i(32558).registerClientReference)(function(){throw Error("Attempted to call CarrouselGlisse() from the server but CarrouselGlisse is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/apps/web/src/app/(app)/carrousel-glisse.tsx","CarrouselGlisse")},54608,a=>{"use strict";var b=a.i(22105);a.n(b)},90157,a=>a.a(async(b,c)=>{try{var d=a.i(66680),e=a.i(62332),f=a.i(21592),g=a.i(31415),h=a.i(49232),i=b([g]);function j(a){return Math.round(100*(1-a))}async function k(a){let b=await g.db.select({matchId:h.schema.picks.matchId,outcome:h.schema.picks.outcome,pAtPick:h.schema.picks.pAtPick}).from(h.schema.picks).where((0,e.eq)(h.schema.picks.userId,a));return new Map(b.map(a=>[a.matchId,{outcome:a.outcome,pAtPick:a.pAtPick}]))}async function l(a){return(await g.db.execute(f.sql`
...
//# sourceMappingURL=apps_web_src_0kfkhfb._.js.map